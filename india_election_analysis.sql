USE [India General Elections 2024];

SELECT * FROM states;

ALTER TABLE constituencywise_details
ADD CONSTRAINT pk_table_name PRIMARY KEY (Candidate,Constituency_ID);
...
WHERE s.State = 'Haryana' AND cr.Constituency_Name = 'Ambala';
